...
const messages = [
  ...
  [
    ...
    "desafortunadmente, ",
    "lastimosamente, ",
    "este no dirige a ningún lado ",
  ],
  [
    "un error ha detectado. ",
    "algo malo ha ocurrido. ",
    "el servidor cayó. ",
    "un bug ha aparecido. ",
    "pixies entró al server! ",
    "el servidor tiene un vació. ",
    "el sitio tiene un mal día. ",
    "nuestro codigo se corrompió. ",
  ],
  [
    "Lo sentimos..",
    "Se reanudará en unos instantes.",
